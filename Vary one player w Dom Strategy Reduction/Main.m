...
% findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_1,playerNum,repetitions)
% player 1 == attacker 1
% player 2 == attacker 2
% player 3 == defender
[nash_a1_1,payoff_a1_1,iter_a1_1,err_a1_1] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_1,1,50);
[nash_a2_1,payoff_a2_1,iter_a2_1,err_a2_1] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_1,2,50);
[nash_d_1,payoff_d_1,iter_d_1,err_a3_1] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_1,3,50);

% find max payoff for player with varied strategies
[~,max_A1_G1_loc] = max(payoff_a1_1(:,1));
[~,max_A2_G1_loc] = max(payoff_a2_1(:,2));
[~,max_D_G1_loc] = max(payoff_d_1(:,3));

max_A1_G1 = payoff_a1_1(max_A1_G1_loc,:)
max_A2_G1 = payoff_a2_1(max_A2_G1_loc,:)
max_D_G1 = payoff_d_1(max_D_G1_loc,:)


% 
% % BUILD THE 2-D GAME COST MATRICES USING THE SETTINGS AND RESPECTIVE GAME REDUCED RESOURCE MATRIX ARRAY
% REDUCED_GAME_COST_MATRIX_1 = GameBuild(1,num_cyber_nodes,REDUCED_RESOURCE_MATRIX_ARRAY_X,CONNECTIONS,COST,threshold);
% 
...
% EXECUTE THE GAME CALCULATION
% findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_X,playerNum,repetitions)
% player 1 == attacker 1
% player 2 == attacker 2
% player 3 == defender
[nash_a1_2,payoff_a1_2,iter_a1_2,err_a1_2] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_2,1,50);
[nash_a2_2,payoff_a2_2,iter_a2_2,err_a2_2] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_2,2,50);
[nash_d_2,payoff_d_2,iter_d_2,err_a3_2] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_2,3,50);

% find max payoff for player with varied strategies
[~,max_A1_G2_loc] = max(payoff_a1_2(:,1));
[~,max_A2_G2_loc] = max(payoff_a2_2(:,2));
[~,max_D_G2_loc] = max(payoff_d_2(:,3));

max_A1_G2 = payoff_a1_2(max_A1_G2_loc,:)
max_A2_G2 = payoff_a2_2(max_A2_G2_loc,:)
max_D_G2 = payoff_d_2(max_D_G2_loc,:)
...
% player 2 == attacker 2
% player 3 == defender
[nash_a1_3,payoff_a1_3,iter_a1_3,err_a1_3] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_3,1,50);
[nash_a2_3,payoff_a2_3,iter_a2_3,err_a2_3] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_3,2,50);
[nash_d_3,payoff_d_3,iter_d_3,err_a3_3] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,REDUCED_RESOURCE_MATRIX_ARRAY_3,3,50);

% find max payoff for player with varied strategies
[~,max_A1_G3_loc] = max(payoff_a1_3(:,1));
[~,max_A2_G3_loc] = max(payoff_a2_3(:,2));
[~,max_D_G3_loc] = max(payoff_d_3(:,3));

max_A1_G3 = payoff_a1_3(max_A1_G3_loc,:)
max_A2_G3 = payoff_a2_3(max_A2_G3_loc,:)
max_D_G3 = payoff_d_3(max_D_G3_loc,:)
...
figure3 = figure;
    fig3_x_axis = categorical({'Vary Attacker 1', 'Vary Attacker 2', 'Vary Defender'});
    fig3_x_axis = reordercats(fig3_x_axis,{'Vary Attacker 1', 'Vary Attacker 2', 'Vary Defender'});
    
  subplot(3,1,1);
    fig3_bar2 = bar(fig3_x_axis,[payoff_a1_1(max_A1_G1_loc,:); payoff_a2_1(max_A2_G1_loc,:); payoff_d_1(max_D_G1_loc,:)]);
    legend({'Vary Attacker 1','Vary Attacker 2','Vary Defender'},'Location','bestoutside');
    title('Max Payoff for Dominating Strategies of Varied Player @ Nash Equilibrium, Game 1');
    ylabel('Max Payoff for Varied Player');
    fig3_bar2_y_axis_min = 0;
    fig3_bar2_y_axis_max = max(unique([payoff_a1_1(max_A1_G1_loc,:); payoff_a2_1(max_A2_G1_loc,:); payoff_d_1(max_D_G1_loc,:)])) * 1.1;
    ylim([fig3_bar2_y_axis_min fig3_bar2_y_axis_max]);
    grid on;
    box on;
    
  subplot(3,1,2);
    fig3_bar2 = bar(fig3_x_axis,[payoff_a1_2(max_A1_G2_loc,:); payoff_a2_2(max_A2_G2_loc,:); payoff_d_2(max_D_G2_loc,:)]);
    legend({'Vary Attacker 1','Vary Attacker 2','Vary Defender'},'Location','bestoutside');
    title('Max Payoff for Dominating Strategies of Varied Player @ Nash Equilibrium, Game 2');
    ylabel('Max Payoff for Varied Player');
    fig3_bar2_y_axis_min = 0;
    fig3_bar2_y_axis_max = max(unique([payoff_a1_2(max_A1_G2_loc,:); payoff_a2_2(max_A2_G2_loc,:); payoff_d_2(max_D_G2_loc,:)])) * 1.1;
    ylim([fig3_bar2_y_axis_min fig3_bar2_y_axis_max]);
    grid on;
    box on;
    
  subplot(3,1,3);
    fig3_bar2 = bar(fig3_x_axis,[payoff_a1_3(max_A1_G3_loc,:); payoff_a2_3(max_A2_G3_loc,:); payoff_d_3(max_D_G3_loc,:)]);
    legend({'Vary Attacker 1','Vary Attacker 2','Vary Defender'},'Location','bestoutside');
    title('Max Payoff for Dominating Strategies of Varied Player @ Nash Equilibrium, Game 3');
    ylabel('Max Payoff for Varied Player');
    fig3_bar2_y_axis_min = 0;
    fig3_bar2_y_axis_max = max(unique([payoff_a1_3(max_A1_G3_loc,:); payoff_a2_3(max_A2_G3_loc,:); payoff_d_3(max_D_G3_loc,:)])) * 1.1;
    ylim([fig3_bar2_y_axis_min fig3_bar2_y_axis_max]);
    grid on;
    box on;
