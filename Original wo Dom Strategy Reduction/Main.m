...
REDUCED_GAME_COST_MATRIX_1 = GameBuild(1,num_cyber_nodes,RESOURCE_MATRIX_ARRAY_1,CONNECTIONS,COST,threshold);

% FIND THE SIZE OF EACH REDUCED RESOURCE ALLOCATIONS MATRIX FOR EACH PLAYER
len_new_strat_1_defender  = size(RESOURCE_MATRIX_ARRAY_1{3});
len_new_strat_1_attacker1 = size(RESOURCE_MATRIX_ARRAY_1{1});
len_new_strat_1_attacker2 = size(RESOURCE_MATRIX_ARRAY_1{2});
...
% BUILD THE 2-D GAME COST MATRICES USING THE SETTINGS AND RESPECTIVE GAME REDUCED RESOURCE MATRIX ARRAY
REDUCED_GAME_COST_MATRIX_2 = GameBuild(1,num_cyber_nodes,RESOURCE_MATRIX_ARRAY_2,CONNECTIONS,COST,threshold);

% FIND THE SIZE OF EACH REDUCED RESOURCE ALLOCATIONS MATRIX FOR EACH PLAYER
len_new_strat_2_defender  = size(RESOURCE_MATRIX_ARRAY_2{3});
len_new_strat_2_attacker1 = size(RESOURCE_MATRIX_ARRAY_2{1});
len_new_strat_2_attacker2 = size(RESOURCE_MATRIX_ARRAY_2{2});
...
% BUILD THE 2-D GAME COST MATRICES USING THE SETTINGS AND RESPECTIVE GAME REDUCED RESOURCE MATRIX ARRAY
REDUCED_GAME_COST_MATRIX_3 = GameBuild(1,num_cyber_nodes,RESOURCE_MATRIX_ARRAY_3,CONNECTIONS,COST,threshold);

% FIND THE SIZE OF EACH REDUCED RESOURCE ALLOCATIONS MATRIX FOR EACH PLAYER
len_new_strat_3_defender  = size(RESOURCE_MATRIX_ARRAY_3{3});
len_new_strat_3_attacker1 = size(RESOURCE_MATRIX_ARRAY_3{1});
len_new_strat_3_attacker2 = size(RESOURCE_MATRIX_ARRAY_3{2});
