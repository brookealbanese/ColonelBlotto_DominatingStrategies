...
%   resource_matrix_attacker1_dimensions = size(RESOURCE_MATRIX_ATTACKER1);
%   resource_matrix_attacker2_dimensions = size(RESOURCE_MATRIX_ATTACKER2);
%   resource_matrix_defender_dimensions  = size(RESOURCE_MATRIX_DEFENDER);
% 
%   resource_matrix_attacker1_rows = resource_matrix_attacker1_dimensions(1);
%   resource_matrix_attacker2_rows = resource_matrix_attacker2_dimensions(1);
%   resource_matrix_defender_rows  = resource_matrix_defender_dimensions(1);
