...
% player 2 == attacker 2
% player 3 == defender
[nash_a1_1,payoff_a1_1,iter_a1_1,err_a1_1] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_1,1,50);
[nash_a2_1,payoff_a2_1,iter_a2_1,err_a2_1] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_1,2,50);
[nash_d_1,payoff_d_1,iter_d_1,err_a3_1] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_1,3,50);
...
% player 2 == attacker 2
% player 3 == defender
[nash_a1_2,payoff_a1_2,iter_a1_2,err_a1_2] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_2,1,50);
[nash_a2_2,payoff_a2_2,iter_a2_2,err_a2_2] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_2,2,50);
[nash_d_2,payoff_d_2,iter_d_2,err_a3_2] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_2,3,50);
...
% player 2 == attacker 2
% player 3 == defender
[nash_a1_3,payoff_a1_3,iter_a1_3,err_a1_3] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_3,1,50);
[nash_a2_3,payoff_a2_3,iter_a2_3,err_a2_3] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_3,2,50);
[nash_d_3,payoff_d_3,iter_d_3,err_a3_3] = findSomeBestResponseStrategies(num_cyber_nodes,CONNECTIONS,COST,threshold,RESOURCE_MATRIX_ARRAY_3,3,50);
...
figure3 = figure;
  ...
  subplot(3,1,1);
    ...
    title('Max Payoff of Varied Player @ Nash Equilibrium, Game 1');
  ...
  subplot(3,1,2);
    ...
    legend({'Vary Attacker 1','Vary Attacker 2','Vary Defender'},'Location','bestoutside');
    title('Max Payoff of Varied Player @ Nash Equilibrium, Game 2');
    ylabel('Max Payoff for Varied Player');
    fig3_bar2_y_axis_min = 0;
  ...
  subplot(3,1,3);
    ...
    legend({'Vary Attacker 1','Vary Attacker 2','Vary Defender'},'Location','bestoutside');
    title('Max Payoff of Varied Player @ Nash Equilibrium, Game 3');
    ylabel('Max Payoff for Varied Player');
    fig3_bar2_y_axis_min = 0;
